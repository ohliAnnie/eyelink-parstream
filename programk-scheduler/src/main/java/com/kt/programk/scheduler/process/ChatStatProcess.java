 ...
 * 대화 통계
 */
public class ChatStatProcess implements Processor {
    /**
     * The constant LOGGER.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ChatStatProcess.class);
     ...
     */
    public ChatStatProcess(ClickStatMapper clickStatMapper) {
    ...
    public void process(Exchange exchange) {
        CLogger.functionStart("ChatStatProcess Start");

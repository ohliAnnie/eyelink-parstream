...
<div class="searchGrpContent">
	...
	<div class="searchGrpContentBox content">
		...
		<div class="tableList fixed">
			<table>
				<caption>일별 통계-기간, 검색 건수, 응답 건수, 응답률(%), 유니크 사용자 수</caption>
				<colgroup>
					<col class="w1 w10p">
					<col class="w2">
					<col class="w3">
				...
				<tbody>
						...
						<tr class="bgA">
							<td><span class="txtPoint">일평균</span></td>
...
<script type="text/javascript">
	...
	function fnSearch(){
		...
		$("#formSearch").attr("action", "<c:url value='/statPeriodDay'/>");
		$("#formSearch").submit();
	}
	...
	function fnDownload(){
		...
		$("#formSearch").attr("action", "<c:url value='/statPeriodDayDownload'/>");
		$("#formSearch").submit();
	}
</script>

<%--
 Class Name  : statOrderInput.jsp
 Description : 통계 - 대화 통계
...
<div class="searchGrpContent">
	...
	<div class="searchGrpContentBox content">
		<!--// 타이틀 및 위치안내 시작 -->
		<div class="titleBox">
			<h3 class="contentTitle">대화 통계</h3>
			<p class="location">
				홈 > 통계 > 검색 순위 통계 > 대화 통계
			</p>
		</div>
		...
		<div class="tableList fixed">
			<table>
				<caption>대화 통계-순위, 대화, 검색 건수</caption>
				<colgroup>
					<col class="w1 w10p">
					<col class="w2">
					<col class="w3">
...
<script type="text/javascript">	
	...
	function fnSearch(){
		...
		$("#formSearch").attr("action", "<c:url value='/statOrderInput'/>");
		$("#formSearch").submit();
	}
	...
	function fnDownload(){
		...
		$("#formSearch").attr("action", "<c:url value='/statOrderInputDownload'/>");
		$("#formSearch").submit();
	}
</script>

...
/**
 * Produces {@link org.aitools.programd.graph.Nodemapper}s based on the classname that
...
public class NodemapperFactory
{
     ...
     * that is configured to create instances of the {@link org.aitools.programd.graph.Nodemapper}

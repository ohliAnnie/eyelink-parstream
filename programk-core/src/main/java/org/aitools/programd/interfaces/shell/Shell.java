...
//                showConsole(this.botName, XMLKit.filterViaHTMLTags(this.core.getResponse(commandLine, this.hostname, this.botid, matches)));
                String response = this.core.getResponse(commandLine, this.hostname, this.botid, matches);
                showConsole(this.botName, new String[]{response});
//                showConsole(this.botName, XMLKit.filterViaHTMLTags(response));
                System.out.println("matches result ===============================");
                for(int i =0; i < matches.size(); i++){
                    System.out.println(matches.get(i).getFileName());
                    System.out.println(matches.get(i).getPath());
                }
            }
    ...
    private void showConsole(String preprompt, String[] message)
    {
        ...
        {
            printlnOut('[' + this.botName + "] " + preprompt + PROMPT + message[index]);
        }
    }

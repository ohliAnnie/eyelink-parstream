...
public class RhinoInterpreter implements Interpreter
{
    ...
    /**
     * @see org.aitools.programd.interpreter.Interpreter#evaluate(String)
     */
    public String evaluate(String expression)
    {
        ...
        {
            logger.error("JavaScript exception (see interpreter log).");
            logger.error("Got exception:" + LINE_SEPARATOR + e + LINE_SEPARATOR + "when processing:" + LINE_SEPARATOR + expression);
        }
        finally 
        {
        	Context.exit();
        ...
        // (otherwise...)
        logger.warn("JavaScript returned null!");
        return EMPTY_STRING;
    }
}
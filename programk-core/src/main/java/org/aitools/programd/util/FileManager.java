...
public class FileManager {
     ...
     * @throws java.io.IOException if the specified file is not found or if some other
     *                             I/O error occurs
     */
     ...
     * @throws java.io.FileNotFoundException if a file with the given path cannot be
     *                                       located
     */
     ...
     * @throws java.io.FileNotFoundException if wild card is misused
     */

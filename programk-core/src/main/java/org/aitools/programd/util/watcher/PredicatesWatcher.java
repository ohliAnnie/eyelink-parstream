 ...
 */
public class PredicatesWatcher extends AbstractWatcher{
     ...
     */
    public PredicatesWatcher(Core coreToUse) {
        super(coreToUse);
    }
    ...
    protected void reload(URL path) {
        this.logger.info(String.format("PredicatesWatcher reloading \"%s\".", path));
        this.core.reLoadPredicates(path);
    }
}
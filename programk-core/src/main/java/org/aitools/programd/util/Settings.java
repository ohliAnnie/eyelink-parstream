...
abstract public class Settings {
    ...
    public Settings() {
        ...
        try {
            ...
            System.out.println("Settings.initialize() ERROR!!!!!");
        }
    }
    ...
    public Settings(URL propertiesPath) {
        this.path = propertiesPath; //root path, core.xml의 schema, bot.xml등은 이 경로를 root로 하여 결정됨
        this.properties = new Properties();
        try {
     ...
     */
    abstract protected void initialize() throws FileNotFoundException;
}

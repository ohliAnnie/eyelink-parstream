 ...
 */
public class SubstitutionsWatcher extends AbstractWatcher {
     ...
     */
    public SubstitutionsWatcher(Core coreToUse) {
        super(coreToUse);
    }
    ...
    protected void reload(URL path) {
        this.logger.info(String.format("SubstitutionsWatcher reloading \"%s\".", path));

        this.core.reLoadSubstution(path);
    }
}
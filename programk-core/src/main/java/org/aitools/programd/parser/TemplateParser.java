...
public class TemplateParser extends GenericParser<AIMLProcessor>
{
    ...
    public TemplateParser(String input, String useridToUse, String botidToUse, Core coreToUse, List<Match> matches) throws TemplateParserException
    {
        super(coreToUse.getAIMLProcessorRegistry(), coreToUse);
        if (input == null)
        {
     ...
     * @throws org.aitools.programd.processor.ProcessorException if the AIML cannot be processed
     */
    ...
    /**
     * @see org.aitools.programd.parser.GenericParser#processResponse(String)
     */
    @Override

    ...
    var handleQuickSidebarChat = function () {
        ...
        var handleChatMessagePost = function (e) {
            ...
            var preparePost = function(dir, time, name, avatar, message) {
                ...
                tpl += '<a href="#" class="name">Gildong Hong</a> ';
            ...
            // handle post
            var time = new Date();
            var message = preparePost('out', (time.getHours() + ':' + time.getMinutes()), "Gildong Hong", 'user1', text);
            message = $(message);
            ...
            setTimeout(function(){
                var time = new Date();
                var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "Taehee Kim", 'user2', 'Lorem ipsum doloriam nibh...');
                message = $(message);
                chatContainer.append(message);

var Index = function () {
	...
	var handleAmChart = function() {
		...
		var chart = AmCharts.makeChart("CSSAnimationChart", {
			...
			graphs: [{
			    ...
			    fillAlphas:  0.7,
			    valueAxis:  "a1",
			    balloonText:  "[[value]] num",
			    legendValueText:  "[[value]] num",
			    legendPeriodValueText:  "total: [[value.sum]] num",
			    lineColor:  "#08a3cc",
			    alphaField:  "alpha",
			},{
			    id: "g2",
	...
	var handleAmChartMap = function() {
		...
		var map = AmCharts.makeChart( "mapChart", {
		  type: "map",
		  "theme": "light",
		  pathToImages: "assets/plugins/charts/amcharts/amcharts/images/",

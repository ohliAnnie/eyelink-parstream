...
function getData() {
  ...
  var in_data = { url : "/timeseries/restapi/getAccTimeseries", type : "GET", data : data };
  ...
  var data = { date : sdate };
  var in_data = { url : "/timeseries/restapi/getProcessTimeseries", type : "GET", data : data };
  ajaxTypeData(in_data, function(result){    
    if (result.rtnCode.code == "0000") {        
  ...
  var in_data = { url : "/timeseries/restapi/getTopTimeseries", type : "GET", data : data };
  ajaxTypeData(in_data, function(result){      
    if (result.rtnCode.code == "0000") {        
  ...
  var in_data = { url : "/timeseries/restapi/getTotalTimeseries", type : "GET", data : data };
  ajaxTypeData(in_data, function(result){        
    if (result.rtnCode.code == "0000") {

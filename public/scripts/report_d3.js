              ...
              data.rtnData.forEach(function(d) {
                  ...
                  switch (d.event_type) {
                      case "1": // 피워
                          ...
                          maxData[d.index][d.dd.getDay()] = maxData[d.index][d.dd.getDay()] < d.active_power ? Math.round(d.active_power) : maxData[d.index][d.dd.getDay()];
                          break;
                      case "17": // 조도
                          d.index = 1;
                          d.event_name = 'ALS';
                          d.als_level = parseInt(d.als_level);
                          maxData[d.index][d.dd.getDay()] = maxData[d.index][d.dd.getDay()] < d.als_level ? Math.round(d.als_level) : maxData[d.index][d.dd.getDay()];
                          break;
                      case "33": // 진동
                          d.index = 2;
                          ...
                          maxData[d.index][d.dd.getDay()] = maxData[d.index][d.dd.getDay()] < d.vibration ? Math.round(d.vibration) : maxData[d.index][d.dd.getDay()];
                          break;
                      case "49": // 노이즈
                          d.index = 3;
                          d.event_name = 'NOISE';
                          ...
                          maxData[d.index][d.dd.getDay()] = maxData[d.index][d.dd.getDay()] < d.noise_decibel ? Math.round(d.noise_decibel) : maxData[d.index][d.dd.getDay()];
                          break;
                      case "65": // GPS
                          d.index = 4;
                          d.event_name = 'GPS';
                          maxData[d.index][d.dd.getDay()] = 0;
                          break;
                      case "81": // 센서상태
                          d.index = 5;
                          d.event_name = 'STREET LIGHT';
                          d.status_power_meter = parseInt(d.status_power_meter);
                          maxData[d.index][d.dd.getDay()] = maxData[d.index][d.dd.getDay()] < d.status_power_meter ? Math.round(d.status_power_meter) : maxData[d.index][d.dd.getDay()];
                          break;
                      case "153": // 재부팅
                          d.index = 6;
                          d.event_name = 'REBOOT';

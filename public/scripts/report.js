...
d3.json("/reports/restapi/getReportRawData", function(err, data){
  if(err) throw error;
   ...
   var minDate = new Date(2016,10,30);
   var maxDate = new Date(2016,11,07); 
   var yesDate = new Date(2016,11,06);
...
/*    .externalLabels(50)
  ...
  eventBar
    ...
    .dimension(todayDim)
    .group(eventBarGroup, "POWER", sel_stack('1'))
 ...
 var eventName = ["POWER", "VIBRATION", "NOISE", "GPS", "STREET LIGHT", "REBOOT"];
 for(var i = 1; i<6; ++i)

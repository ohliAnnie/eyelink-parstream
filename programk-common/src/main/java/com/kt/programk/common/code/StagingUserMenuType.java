 ...
 *  preludio     16. 12.07 staging에만 있는 메뉴 추가
 *
 */
 ...
 * CMS 사용자 메뉴 권한
 */
public enum StagingUserMenuType {
    /**
     * menu type.
     */
    ...
    /**
     * F 102 user menu type.
     */
    F102("3", "F102", "로그 처리", "/listChatLogProcess", ""),
    /**
     ...
     * @param icon  the icon
     */
    StagingUserMenuType(String depth, String value, String label, String url, String icon) {
        this.depth = depth;
        this.value = value;
        this.label = label;
        this.url = url;

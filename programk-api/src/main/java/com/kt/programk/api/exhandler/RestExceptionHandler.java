 ...
 * {@code HttpMessageConverter} instance that {@link org.springframework.http.converter.HttpMessageConverter#canWrite(Class, org.springframework.http.MediaType) canWrite}
 ...
 * {@link org.springframework.http.converter.HttpMessageConverter HttpMessageConverter}.  If you want the raw {@code RestError} instance to
...
public class RestExceptionHandler extends AbstractHandlerExceptionResolver implements InitializingBean {
    ...
    protected ModelAndView getModelAndView(ServletWebRequest webRequest, Object handler, RestError error) throws ServletException, IOException {
